...
<html lang="ko">
  <head>
	...
	k='102154414-5',d=document,l=d.location,c=d.cookie;
	      ...
	      <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	           <div class="embed-responsive embed-responsive-16by9">
	            <iframe id="ytplayer${i.index}" class="embed-responsive-item _player _player" src="${v.videoUrl}?enablejsapi=1"></iframe> 
	          </div>
	        </div>
	      </div>
      </c:forEach>
